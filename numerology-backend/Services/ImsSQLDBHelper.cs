...
namespace OmsSolution.Services
{
    public class ImsSQLDBHelper
    {
        ...
        public ImsSQLDBHelper(IConfiguration _configuration, IHttpContextAccessor contextAccessor)
        {
            Configuration = _configuration;
            _contextAccessor = contextAccessor;
            CONNECTION_STRING = this.Configuration.GetConnectionString("ImsDB");
        }
